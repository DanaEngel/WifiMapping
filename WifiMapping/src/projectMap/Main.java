...
/**
 * @author Dana and Enna This class is the main class in which the program
 *         enters to. It creates a CSV file and uses it to create a new KML file
 *         by filtered fields.
 */
...
public class Main {
	public static void main(String[] args) {
		...
		System.out.println("*******************************************");
		// ReadToKml readKml = new ReadToKml(new
		// File("C:\\Users\\dana\\Desktop\\result.csv"));
